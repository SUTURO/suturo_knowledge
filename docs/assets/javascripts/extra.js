$(document).ready(function () {
    ...
    if ($('#objects-last-update').length) {
        $.ajax({
            url: 'https://api.github.com/repos/SUTURO/suturo_knowledge/commits?sha=website&path=docs/objects/owl2anything/output/',
    ...
    if ($('#objects-downloads').length) {
        ...
        $.ajax({
            url: `https://api.github.com/repos/SUTURO/suturo_knowledge/contents/${repoFolderPath}?ref=website`,
            success: function (data) {
