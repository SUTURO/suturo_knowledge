...
- [`create_object(-Object, +Type, +PoseStamped, +Options)`](https://github.com/SUTURO/suturo_knowledge/blob/master/suturo_knowledge/planning-interface.md#create-an-object): Used to instantiate/create new, perceived objects
- [`object_rel_pose(+Object, +Type, +Options, -PoseStamped)`](https://github.com/SUTURO/suturo_knowledge/blob/master/suturo_knowledge/planning-interface.md#getting-important-poses-for-the-robot-to-interact-with-objects): Returns important poses for a given object (e.g. from where to perceive it or where to place it)
- [`predefined_origin_location(+Type, -Location)`](https://github.com/SUTURO/suturo_knowledge/blob/master/suturo_knowledge/planning-interface.md#getting-the-predefined-location-of-an-object): Returns the predefined location for a given object type (e.g. the predefined location of bowls is on inside of Shelf_FIFFJO)
- `next_object(-Object)`: Returns the next best object to be processed/picked for a given challenge

The detailed documentation of the predicates can be found in the [Planning Interface](https://github.com/SUTURO/suturo_knowledge/blob/master/suturo_knowledge/planning-interface.md).
